...
class WishlistUiTests(unittest.TestCase):
    def test_wishlist_template_has_required_fields_and_actions(self) -> None:
        ...
        self.assertIn("data-add-existing-list", tpl)
        self.assertIn("data-add-duplicate-hint", tpl)
        self.assertIn("data-add-submit-btn", tpl)
        ...
        self.assertIn("/tracker/duplicate-check", tpl)
        self.assertIn("已存在追踪条目", tpl)
        self.assertIn("已添加项目（共 ", tpl)
        self.assertIn("点此前往编辑", tpl)
