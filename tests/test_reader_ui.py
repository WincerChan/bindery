...
class ReaderUiTests(unittest.TestCase):
    def test_preview_template_has_toc_and_controls(self) -> None:
        ...
        self.assertIn("display:flex!important;flex-wrap:nowrap!important;align-items:stretch!important", tpl)
        self.assertIn("#bindery-reader-pages{display:block!important;flex:0 0 100%!important;position:relative!important;float:none!important;clear:both!important;width:100%!important;min-width:100%!important", tpl)
        self.assertIn("#bindery-reader-tail{display:block!important;flex:0 0 var(--bindery-page-tail-pad,0px)!important", tpl)
